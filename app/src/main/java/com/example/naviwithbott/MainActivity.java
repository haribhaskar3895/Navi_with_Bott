...
public class MainActivity extends AppCompatActivity {
    ...
    private void initNavigation() {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_edit_profile, R.id.nav_subscribtion,R.id.nav_announcement,
                R.id.nav_suggestion, R.id.nav_invite, R.id.nav_customer_support,
                R.id.bottom_home, R.id.bottom_subscription,R.id.bottom_search, R.id.bottom_more)
